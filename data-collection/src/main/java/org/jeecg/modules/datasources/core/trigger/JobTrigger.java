package org.jeecg.modules.datasources.core.trigger;
...
import org.jeecg.modules.datasources.core.util.JSONUtils;
...
import org.jeecg.rpc.util.IpUtil;
...
public class JobTrigger {
   ...
   */
    public static void trigger(int jobId, TriggerTypeEnum triggerType, int failRetryCount, String executorShardingParam, String executorParam) {
      WaterfallJobInfo jobInfo = JobAdminConfig.getAdminConfig().getJobInfoMapper().loadById(jobId);
      if (jobInfo == null) {
      ...
      WaterfallJobGroup group = JobAdminConfig.getAdminConfig().getJobGroupMapper().load(jobInfo.getJobGroup());
//
      // sharding param
...
//
   ...
   */
  private static void processTrigger(WaterfallJobGroup group, WaterfallJobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total) {
//
...
//
      ...
      WaterfallJobLog jobLog = new WaterfallJobLog();
      jobLog.setJobGroup(jobInfo.getJobGroup());
      jobLog.setJobId(jobInfo.getId());
      jobLog.setTriggerTime(triggerTime);
      jobLog.setJobDesc(jobInfo.getTaskDesc());
//
...
//
      ...
      triggerParam.setJobJson(jobInfo.getTaskExecuteJson());
//
      //increment parameter
      ...
      if (incrementType != null) {
          ...
          if (IncrementTypeEnum.ID.getCode() == incrementType) {
              ...
              triggerParam.setStartId(Long.valueOf(jobInfo.getIncStartId()));
...
//
  private static long getMaxId(WaterfallJobInfo jobInfo) {
      WaterfallDataSource datasource = JobAdminConfig.getAdminConfig().getJobDatasourceMapper().selectById(jobInfo.getOriginalId());
      return 1;
  }
//
  /**
