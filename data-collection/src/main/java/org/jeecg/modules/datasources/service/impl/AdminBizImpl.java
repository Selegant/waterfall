...
public class AdminBizImpl implements AdminBiz {
    ...
    private ReturnT<String> callback(HandleCallbackParam handleCallbackParam) {
        // valid log item
        WaterfallJobLog log = jobLogMapper.load(handleCallbackParam.getLogId());
        if (log == null) {
        ...
        if (IJobHandler.SUCCESS.getCode() == resultCode) {
            ...
            WaterfallJobInfo jobInfo = jobInfoMapper.loadById(log.getJobId());
    ...
    private void updateIncrementParam(WaterfallJobLog log, Integer incrementType) {
