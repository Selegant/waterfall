package org.jeecg.modules.datasources.core.conf;

import org.jeecg.modules.datasources.core.scheduler.JobScheduler;
import org.jeecg.modules.datasources.mapper.*;
...
public class JobAdminConfig implements InitializingBean, DisposableBean {
    ...
    @Resource
    private WaterfallJobLogMapper jobLogMapper;
    @Resource
    private WaterfallJobInfoMapper jobInfoMapper;
    @Resource
    private WaterfallJobRegistryMapper jobRegistryMapper;
    @Resource
    private WaterfallJobGroupMapper jobGroupMapper;
    @Resource
    private WaterfallJobLogReportMapper jobLogReportMapper;
    @Resource
    private JavaMailSender mailSender;
    @Resource
    private DataSource dataSource;
    @Resource
    private WaterfallDataSourceMapper jobDatasourceMapper;
    ...
    public WaterfallJobLogMapper getJobLogMapper() {
        return jobLogMapper;
    }

    public WaterfallJobInfoMapper getJobInfoMapper() {
        return jobInfoMapper;
    }

    public WaterfallJobRegistryMapper getJobRegistryMapper() {
        return jobRegistryMapper;
    }

    public WaterfallJobGroupMapper getJobGroupMapper() {
        return jobGroupMapper;
    }

    public WaterfallJobLogReportMapper getJobLogReportMapper() {
    ...
    public WaterfallDataSourceMapper getJobDatasourceMapper() {
